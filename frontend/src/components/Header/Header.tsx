        ...
        <header className="top-header">
          ...
          <nav className={`desktop-nav ${isMenuOpen ? 'mobile-open' : ''}`}>
            <ul>
              ...
              <li>
                <NavLink to="/temperature" onClick={closeMenu}>Temperatur</NavLink>
              </li>
              <li>
                <NavLink to="/humidity" onClick={closeMenu}>Luftfeuchtigkeit</NavLink>
              </li>
              <li>
                <NavLink to="/history" onClick={closeMenu}>Historie</NavLink>
              </li>
              <li>
                <NavLink to="/settings" onClick={closeMenu}>Einstellungen</NavLink>
              </li>
            </ul>
          </nav>
        </header> 
